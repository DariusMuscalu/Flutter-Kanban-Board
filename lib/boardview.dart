...
class BoardView extends StatefulWidget {
  ...
  /// This seems like it is never used somewhere, see further if you comment the code if something happens
  bool? scrollbar;
    ...
    if (initialX != null &&
      ...
      if (canDrag && dxInit != null && dyInit != null && !isInBottomWidget) {
        if (draggedItemIndex != null &&
          ...
          if (dy! < topListY! + 70) {
            //scroll up
            if (listStates[draggedListIndex!].boardListScrollController !=
                    null &&
...
//                }
  ...
  void moveDraggedItemAboveAnother() {
    if (topItemY != null) {
      topItemY = topItemY! -
          listStates[draggedListIndex!]
              .itemStates[draggedItemIndex! - 1]
